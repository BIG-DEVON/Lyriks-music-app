...
const TopChartCard = ({ song, i,isPlaying,activeSong,
  ...
  <div
    ...
    hover:bg-[#4c426e] ${activeSong?.title === song?.title ? 'bg-[#4c426e]' : 'bg-transparent'} 
     ...
     justify-between items-center "> 
        <img src={song?.images?.coverart } alt={song?.title}
          ...
          <p className="text-base font-semibold
           text-gray-300 mt-1">{song?.subtitle}</p>
          </Link>
          </div>
     </div>
     <PlayPause 
...
const TopPlay = () => {
  ...
  return (
    <div
      ref={divRef}
      className="xl:ml-6 ml-0 xl:mb-0 
      mb-6 flex-1 xl:max-w-[500px]
        ...
        <div
          ...
          <h2
            className="text-white font-bold
               text-2xl "> Top Charts   </h2>
          <Link to="/top-charts">
            <p
              className="text-gray-300 
              text-base cursor-pointer">See more</p>
          </Link>
        </div>
